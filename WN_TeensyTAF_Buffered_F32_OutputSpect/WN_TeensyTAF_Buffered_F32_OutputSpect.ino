...
float templt[TEMPLT_SIZE] = {0.24,0.24,0.24,0.24,0.24,0.24,0.24,0.24,0.24,0.24,0.24,0.24,0.24,0.24,0.24,0.24,0.24,0.24,-0.88,-2.98,-2.07,-0.18,0.24,0.24,0.24,0.24,0.24,0.24,0.24,0.24,0.24,0.24,0.15,-0.01,-0.21,-0.51,-1,-1.89,-2.56,-1.9,-0.31,1.32,2.53,3.17,3.28,2.95,2.41,1.71,1.18,0.65,0.26,0.07,0,0.15,0.24,0.24,-0.07,-0.48,-0.53,-0.26,0.24,0.24,0.24,0.24,0.24,0.24,0.24,0.24,0.24,0.24,0.24,0.24,0.24,0.24,0.24,0.24,0.24,0.24,0.24,0.24,0.24,0.24,-0.88,-2.98,-2.07,-0.18,0.24,0.24,0.24,0.24,0.24,0.24,0.24,0.24,0.24,0.24,0.15,-0.01,-0.21,-0.51,-1.01,-2.1,-3.11,-2.96,-2.08,-1.15,-0.58,-0.26,-0.01,0.13,0.24,0.24,0.24,0.07,-0.05,-0.03,0,0.15,0.24,0.24,-0.07,-0.48,-0.53,-0.26,0.24,0.24,0.24,0.24};
...
int FREQTHRESH = 3686 ;  /////////// Frequency Limits
int PercentHits = 80; /////////  Maintain this percent hits.
...
void setup() {
  ...
  analogWrite(TRIGGER_OUTPUT_PIN,0);  
...
//
  ...
  if (AboveThresh > AMPLITUDE_THRESHOLD_DURATION) {   // e.g. has there been sound?
    timea = micros();
    eventCounter++;
    writeSerialTimeEvent();
    Serial.print("amp_threshold,");
    Serial.println(RUNNING_AMP);
...
void samplingCallback() {
  ...
  samples[sampleCounter] = samples[sampleCounter] - 32767;
...
void export_mags() {
   ...
   Serial.print("PSD");
       for (int i=0; i<=TEMPLT_SIZE-1; i++) {
            scaledOut[i]=(float)magnitudes[i];
            scaledOut[i]=scaledOut[i]/fftmax;
            Serial.print(',');
            Serial.print(scaledOut[i]); 
            delay(8);                           // required for consistent output of PSD over serial
